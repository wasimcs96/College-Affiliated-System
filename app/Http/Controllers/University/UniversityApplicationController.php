...
class UniversityApplicationController extends Controller
{
   public function index()
   {
     ...
     return view('university.application.application')->with('applications', $applications);
   }
   ...
   public function applicationCreate($id)
   {
    ...
    foreach($bookings as $booking)
    {
       ...
       return view('university.application.application_create',compact('application','university','course'));
   }
