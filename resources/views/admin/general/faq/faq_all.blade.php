    ...
    <div class="card">
        <div class="header">
            ...
            <ul class="header-dropdown dropdown">
               ...
               <li><a  style="color: white;" href="{{route('admin.general.faq')}}"class="btn btn-primary"><i class="fa fa-plus"></i>{!! "&nbsp;"!!}Add</a></li>
                {{-- <li class="dropdown">
                   ...
                   <tbody>
                    @foreach ($faqs as $faq)
                        <tr>
                            ...
                            <a href="{{route('admin.general.faq.edit', $faq->id ?? '')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" alt="Edit course" title="" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                            &nbsp;&nbsp;

                              <a href="{{route('admin.general.faq.delete', $faq->id ?? '')}}" class="confirmDeleteBtn btn btn-danger btn-sm btn-flat" data-toggle="tooltip" alt="Delete Course" data-url="" data-title="Delete"><i class="fa fa-trash"></i></a>
