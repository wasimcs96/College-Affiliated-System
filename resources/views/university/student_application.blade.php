...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h2>See Application of Student</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" novalidate action="#">
                                ...
                                <div class="form-group">
                                    <label for="documents">Uploaded Documents</label>

                                <br />
                                <label class="control-inline fancy-checkbox">
                            <div class="dynamic_document" id="dynamic_document">
                                    <input checked type="checkbox" name="10marksheet" required data-parsley-check="[1,5]" data-parsley-errors-container="#error-checkbox3">
                                    <span>Marksheet-10</span>
                                </label>
                                <label class="control-inline fancy-checkbox">
                                    <input checked type="checkbox" name="aadhar">
                                    <span>Aadhar Card</span>
                                </label>
                                <label class="control-inline fancy-checkbox">
                                    <input checked type="checkbox" name="12marksheet">
