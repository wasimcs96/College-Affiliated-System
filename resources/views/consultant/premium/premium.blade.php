...
<li><a class="btn btn-primary btn-sm" style="color: white;" href="{{route('consultant.gopremium')}}">Go Premium</a></li>
...
{{-- {{dd($premium->userPurchasedPlans)}} --}}
                        ...
                        <tr>
                            ...
                            <td>{{ Config::get('define.currency.currency') }}{{$premium->amount ?? ''}}</td>
