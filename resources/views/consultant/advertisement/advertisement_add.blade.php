    ...
    <div class="col-lg-4 cool-md-4 col-sm-12">
        <div class="card">
            <ul class="pricing body">
                ...
                <li class="plan-btn"><button class="btn btn-round btn-outline-secondary">
                    {{-- <input type="checkbox" value="1" name="expire_date" data-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger"> --}}
               <input type="radio" name="expire_date" value="{{ $package->expire_date }}" onclick="update('{{ $package->expire_date }}');" />Choose plan</button></li>
            </ul>
        </div>
    </div>
    @endforeach
