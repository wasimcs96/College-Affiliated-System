...
@csrf
        ...
        <div class="card">
            <ul class="pricing body">
                ...
                <li class="price">
                    <h3><span>{{ Config::get('define.currency.currency') }}</span>{{$package->amount}}<small>{!! "&nbsp;" !!}/{!! "&nbsp;" !!}{{$package->package_time}}{!! "&nbsp;" !!}-{!! "&nbsp;" !!}months</small></h3>                    <span>Advertisement</span>
                </li>
                <li>{{$package->title ?? ''}}</li>
...
<div class="container">
    ...
    <div class="modal fade" id="mdlup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        ">
              ...
              <a href="{{route('consultant.advertisement')}}" class="btn btn-primary" style="
