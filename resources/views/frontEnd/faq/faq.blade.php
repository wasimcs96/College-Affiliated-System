            ...
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        ...
                        <span class="d-block info__title">Consultant Question</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
            ...
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        ...
                        <span class="d-block info__title">Study Abroad</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        ...
                        <span class="d-block info__title">Fees & Transactions</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
