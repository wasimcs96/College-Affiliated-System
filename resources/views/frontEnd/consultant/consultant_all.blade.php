        ...
        <div class="row">
            <div class="col-lg-4 responsive-column">
                <div class="card-item car-card border">
                    ...
                    <div class="card-body">
                        <p class="card-meta">Premium </p>
                        <h3 class="card-title"><a href="{{route('consultant_detail')}}">John Wick</a></h3>
                        ...
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                ...
                                <span class="price__text">Iran</span>
                            </p>
                            <a href="{{route('consultant_detail')}}" class="btn-text">See details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
                </div><!-- end card-item -->
            </div><!-- end col-lg-4 -->
