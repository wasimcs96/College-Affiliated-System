                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title line-height-50">{{$policy->title ?? ''}}</h2>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading margin-bottom-40px">
                    <h2 class="sec__title">{{$policy->title ?? ''}}</h2>
                    <h4 class="title font-size-16 line-height-26 pt-4 pb-2">{!! $policy->short_description ?? '' !!}</h4>
                    <p class="sec__desc font-size-16 pb-3">{!! $policy->description ?? ''!!}</p>
        ...
        <div class="row padding-top-100px">
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team1.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Zubair kaardsham</h3>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team2.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Saif Qureshi</h3>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team3.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Sufiyan Qureshi</h3>
             ...
             <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team4.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Zunaid(cobra)</h3>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team5.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Saad Bhati</h3>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/team6.jpg')}}" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">Ammar tanwar</h3>
...
{{-- <section class="cta-area cta-bg-2 bg-fixed section-padding text-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2 class="sec__title mb-3 text-white">Interested in a career <br> at Digital Colf.</h2>
