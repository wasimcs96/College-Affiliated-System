    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 responsive-column">
                <div class="card-item ">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/img21.jpg')}}" alt="about-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item ">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/img22.jpg')}}" alt="about-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item ">
                    <div class="card-img">
                        <img src="{{asset('frontEnd/assets/images/img23.jpg')}}" alt="about-img">
                    </div>
                    <div class="card-body">
