    ...
    <div class="sidebar-scroll">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Students</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Search</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Booking</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Offer Received</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Accepted</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Ready to fly</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>PR/Migration</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Services</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Go Premium</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>University Request</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>AD/Events</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Dues/Billing</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>FeedBack</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-speedometer"></i><span>Dashboard</span></a></li>
                <li class="{{ Request::segment(2) === 'index3' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Students</span></a></li> --}}
                ...
                {{-- <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Dashboard</span></a></li> --}}
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('consultant.students')}}"><i class="icon-diamond"></i><span>Students</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Search</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('consultant.bookings')}}"><i class="icon-diamond"></i><span>Booking</span></a></li>
                ...
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Ready to fly</span></a></li>
                ...
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Services</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Go Premium</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>University Request</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>FeedBack</span></a></li>
                ...
                <li class="{{ Request::segment(1) === 'projects' ? 'active open' : null }}">
                    ...
                    <ul> --}}
                        ...
                        <li class="{{ Request::segment(2) === 'addproject' ? 'active' : null }}"><a href="{{route('projects.addproject')}}">Applied</a></li>
                        <li class="{{ Request::segment(2) === 'ticket' ? 'active' : null }}"><a href="{{route('projects.ticket')}}">Offer Received</a></li>
                        <li class="{{ Request::segment(2) === 'ticketdetails' ? 'active' : null }}"><a href="{{route('projects.ticketdetails')}}">Accepted</a></li>
                        <li class="{{ Request::segment(2) === 'clients' ? 'active' : null }}"><a href="{{route('projects.clients')}}">Ready to fly</a></li>
                        <li class="{{ Request::segment(2) === 'todo' ? 'active' : null }}"><a href="{{route('projects.todo')}}">PR/Migration</a></li> --}}
                    {{-- </ul>
                </li>
                <li class="{{ Request::segment(1) === 'hr' ? 'active open' : null }}">
                    ...
                    <ul> --}}
                        {{-- <li class="{{ Request::segment(2) === 'hrdashboard' ? 'active' : null }}"><a href="{{route('hr.hrdashboard')}}"><i class="icon-flag"></i><span>Services</span></a></li>
                        <li class="{{ Request::segment(2) === 'users' ? 'active' : null }}"><a href="{{route('hr.users')}}">Go Premium</a></li>
                        <li class="{{ Request::segment(2) === 'departments' ? 'active' : null }}"><a href="{{route('hr.departments')}}">University Request</a></li>
                        <li class="{{ Request::segment(2) === 'employee' ? 'active' : null }}"><a href="{{route('hr.employee')}}">AD/Events</a></li>
                        <li class="{{ Request::segment(2) === 'activities' ? 'active' : null }}"><a href="{{route('hr.activities')}}">Dues/Billing</a></li>
                        <li class="{{ Request::segment(2) === 'holidays' ? 'active' : null }}"><a href="{{route('hr.holidays')}}">FeedBack</a></li> --}}
