    ...
    <div class="sidebar-scroll">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('university.students')}}"><i class="icon-diamond"></i><span>Students</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Services</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('university.courses')}}"><i class="icon-diamond"></i><span>Courses</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Intro to new consultant</span></a></li>
                ...
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Ad</span></a></li>
                ...
                <li class="{{ Request::segment(2) === 'index3' ? 'active open' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Students</span></a></li> --}}
                ...
                <li class="{{ Request::segment(1) === 'projects' ? 'active open' : null }}">
                    ...
                    <ul> --}}
                        ...
                        <li class="{{ Request::segment(2) === 'projectlist' ? 'active' : null }}"><a href="{{route('projects.projectlist')}}">Intro to new Consultant</a></li>
                        <li class="{{ Request::segment(2) === 'addproject' ? 'active' : null }}"><a href="{{route('projects.addproject')}}">Go Premium</a></li>
                        <li class="{{ Request::segment(2) === 'ticket' ? 'active' : null }}"><a href="{{route('projects.ticket')}}">Ad</a></li>
