        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
             ...
             {{-- <li class="{{ Request::segment(2) == 'dashboard' ? 'active' : null }}"><a href="javascript:void(0);"> <i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                ...
                <li class="{{ Request::segment(2) == 'services' ? 'active open' : null }}">
                    ...
                    <li class="{{ Request::segment(3) == 'subscription' ? 'active' : null }}"><a href="{{ route('university.subscription.add')}}">Subscription</a></li>
            ...
            <li class="{{ Request::segment(2) == 'terms_condition' ? 'active' : null }}"><a href="javascript:void(0);"><i class="fa fa-lock"></i><span>Terms & Conditions</span></a></li>
             ...
             @else
                ...
                <li class="{{ Request::segment(2) == 'courses' ? 'active' : null }}"><a href="{{route('university.courses')}}"><i class="icon-notebook"></i><span>My Courses</span></a></li>
                <li class="{{ Request::segment(2) == 'students' ? 'active' : null }}"><a href="{{route('university.students')}}"><i class="icon-users"></i><span>My Students</span></a></li>
                ...
                <li class="{{ Request::segment(2) == 'application' ? 'active' : null }}"><a href="{{route('university.application')}}"><i class="icon-notebook"></i><span>Applications</span></a></li>
                <li class="{{ Request::segment(2) === 'messenger' ? 'active open' : null }}"><a href="{{route('university.messenger')}}"><i class="icon-bubbles"></i><span>Messenger</span></a></li>
