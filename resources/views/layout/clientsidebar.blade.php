    ...
    <div class="sidebar-scroll">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu">
                ...
                {{-- <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Dashboard</span></a></li> --}}
                {{-- <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Students</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>Search</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Booking</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Offer Received</span></a></li>
                <li class="{{ Request::segment(2) === 'index2' ? 'active' : null }}"><a href="{{route('dashboard.index2')}}"><i class="icon-diamond"></i><span>Accepted</span></a></li>
                ...
                <li class="{{ Request::segment(2) === 'index3' ? 'active open' : null }}"><a href="{{route('dashboard.index3')}}"><i class="icon-diamond"></i><span>My Favourites</span></a></li> --}}
                ...
                <li class="{{ Request::segment(1) === 'projects' ? 'active open' : null }}">
                    ...
                    <ul> --}}
                        {{-- <li class="{{ Request::segment(2) === 'taskboard' ? 'active' : null }}"><a href="{{route('projects.taskboard')}}">Booking</a></li>
                        <li class="{{ Request::segment(2) === 'projectlist' ? 'active' : null }}"><a href="{{route('projects.projectlist')}}">My Status</a></li>
                        <li class="{{ Request::segment(2) === 'addproject' ? 'active' : null }}"><a href="{{route('projects.addproject')}}">Chat and Feedback</a></li>
                ...
                <li class="{{ Request::segment(1) === 'hr' ? 'active open' : null }}">
                    ...
                    <ul> --}}
                        {{-- <li class="{{ Request::segment(2) === 'hrdashboard' ? 'active' : null }}"><a href="{{route('hr.hrdashboard')}}">Services</a></li>
