    ...
    <div class="card">
        ...
        <div class="body">
            <div class="table-responsive">
                ...
                <a href="{{route('subadmin.booking.followup')}}" id="bac" class="btn btn-danger btn-flat">Back</a>
                <a style="text-align: center;" href="{{route('subadmin.booking.show',['id'=> $booking->booking_id])}}" class="btn btn-primary">Go to Booking<i class="icon-arrow"></i></a>
