...
@section('content')
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('subadmin/dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="{{url('subadmin/settings/general')}}">Settings</a></li>
            ...
            timer = setInterval(function () {
                if ($('#form-upload input[name=\'file\']').val() !== '') {
                    ...
                    $.ajax({
                        ...
                        url: '{{url('subadmin/settings/store-image-temp')}}',
                        type: 'post',
                        dataType: 'json',
