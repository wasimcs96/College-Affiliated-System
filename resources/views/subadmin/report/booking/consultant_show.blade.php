...
<div class="col-lg-12">
    <div class="card">
        ...
        {{-- </tr> --}}
                ...
                {{-- <a  href="{{route('subsubadmin.report.booking.consultant_app')}}" class="btn btn-success btn-flat" id="accept">Accept</a> --}}
...
{{-- <script>
   $("#accept").click(function() {
    $("#accept").remove()
    $("#bac").remove()
    $("#res").html("<a  href='{{route('subsubadmin.booking.consultant_app')}}' class='btn btn-success btn-flat' id='accept'>Create Application</a>")
    $("#dec").html("<a href='{{route('subsubadmin.booking.consultant')}}' class='btn btn-danger btn-flat'>Close</a>")
