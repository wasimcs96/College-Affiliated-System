    ...
    <div class="card">
        ...
        <div class="body">
            <div class="table-responsive">
                ...
                <a href="{{route('subadmin.application.followup')}}" id="bac" class="btn btn-danger btn-flat">Back</a>
                <a style="text-align: center;" href="{{route('subadmin.application.create',['id'=> $applications->application_id])}}" class="btn btn-primary">Go to Application<i class="icon-arrow"></i></a>
