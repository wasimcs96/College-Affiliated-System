...
@if($user->isConsultant())
                ...
                @if($user->isClient())
                   <a href="{{route('subadmin.users',['id'=>1])}}" id="bac" class="btn btn-danger btn-flat">Back</a>
                @endif
                @if($user->isConsultant())
                   <a href="{{route('subadmin.users',['id'=>2])}}" id="bac" class="btn btn-danger btn-flat">Back</a>
                @endif
                @if($user->isUniversity())
                   <a href="{{route('subadmin.users',['id'=>3])}}" id="bac" class="btn btn-danger btn-flat">Back</a>
                @endif
            </div>
        </div>
    </div>
