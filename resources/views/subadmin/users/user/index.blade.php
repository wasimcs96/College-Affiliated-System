                                ...
                                @foreach ($users as $user)
                                    @if($user->isClient())
                                        <tr>
                                            ...
                                            <td><a href="{{route('subadmin.user.show',['id' => $user->id])}}" class="btn btn-success"><i class="icon-eye"></i></a>
                                            <a href="{{route('subadmin.user.edit',['id' => $user->id])}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('subadmin.user.delete',['id' => $user->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                    @endif
                                @endforeach
                            </tbody>
                                ...
                                @foreach ($users as $user)
                                    @if($user->isConsultant())
                                        <tr>
                                            ...
                                            <td><a href="{{route('subadmin.user.show',['id' => $user->id])}}" class="btn btn-success"><i class="icon-eye"></i></a>
                                            <a href="{{route('subadmin.user.edit',['id' => $user->id])}}" class="btn btn-warning"><i class="icon-pencil"></i></a>
                                            <a href="{{route('subadmin.user.delete',['id' => $user->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                    @endif
                                @endforeach
