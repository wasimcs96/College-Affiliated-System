            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" novalidate action="{{route('subadmin.category.update', $category->id)}}" enctype="multipart/form-data">
                                @csrf
                           ...
                           <div class="body"id="nb"  >
                              <input type="file" name="image"class="dropify" >
                                ...
                                <a href="{{route('subadmin.category')}}"class="btn btn-danger">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
